...
//	}
	...
	public String getCityIdByCityName(String cityName) throws NGException {
		String cityId = cacheBuilder.localCache.get("cityIdList::"+cityName);
		if(cityId != null) {
			return cityId;
		} else {
			logger.info("Fetching from db - cityId from cityName", cityName);
			cityId = cityDAO.getCityIdByCityName(cityName);
			cacheBuilder.localCache.put("cityIdList::"+cityName, cityId);
		}
		return cityId;
	}
